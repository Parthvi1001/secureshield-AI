        ...
        <header className="rounded-3xl border border-slate-800/80 bg-slate-950/70 px-4 py-4 shadow-[0_12px_40px_rgba(2,8,23,0.45)] backdrop-blur-md sm:px-6">
          <div className="grid gap-4 lg:grid-cols-[1fr_auto_1fr] lg:items-center">
            <div className="flex items-center gap-3">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400 via-blue-500 to-slate-900 shadow-[0_0_28px_rgba(34,211,238,0.35)]">
                <IconShield />
              </div>
              ...
              {featureLinks.map((link) => (
                <Link
                  ...
                  className={`rounded-full px-5 py-2 text-sm font-medium transition-colors ${
                    link.label === 'Sign Up'
                      ? 'bg-gradient-to-r from-blue-500 to-cyan-400 text-white shadow-lg shadow-cyan-500/20 hover:from-blue-400 hover:to-cyan-300'
                      : 'border border-slate-700 bg-slate-900/60 text-slate-100 hover:border-cyan-400 hover:text-cyan-300'
                  }`}
                >
                  {link.label}
                </Link>
          ...
          <section className="grid items-center gap-10 py-10 lg:grid-cols-2 lg:py-16">
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <Link
                  to="/signup"
                  className="rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 px-7 py-3 text-sm font-semibold text-white shadow-[0_10px_30px_rgba(34,211,238,0.22)] transition-colors hover:from-blue-400 hover:to-cyan-300"
                >
                  Get Started
                </Link>
                <a
                  href="#contact"
                  className="rounded-full border border-slate-700 bg-slate-900/60 px-7 py-3 text-sm font-semibold text-slate-100 transition-colors hover:border-cyan-400 hover:text-cyan-300"
                >
                  Learn More
                </a>
              </div>
            ...
            <div className="rounded-[2rem] border border-slate-800 bg-slate-950/70 p-4 shadow-[0_20px_60px_rgba(2,8,23,0.45)]">
              <CyberIllustration />
            </div>
          </section>
        </main>
